...
const EarningSummary = () => {
  ...
  const yAxisDomain = [0, maxAmount * 1.25];
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 space-y-10 w-full max-w-7xl mx-auto">
      {/* Header */}
      <div className="text-center">
        ...
        <div className="inline-flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
          <span className="text-4xl sm:text-6xl font-extrabold bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">
            BDT {totalEarnings.toLocaleString()}
          </span>
          <span className="text-lg sm:text-2xl font-light text-blue-300">
            earned
          </span>
        </div>
      </div>
      ...
      <div className="relative overflow-hidden rounded-3xl backdrop-blur-2xl bg-gradient-to-br from-white/10 via-blue-500/5 to-cyan-500/5 border border-blue-400/20 shadow-2xl">
        ...
        <div className="relative p-4 sm:p-8 pb-12">
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-6 sm:mb-10 flex items-center gap-3 sm:gap-4">
            <div className="w-1.5 sm:w-2 h-10 sm:h-12 bg-gradient-to-b from-blue-400 to-cyan-400 rounded-full shadow-lg shadow-blue-500/50" />
            Earnings by Service
          </h3>
      ...
      <div className="rounded-3xl backdrop-blur-2xl bg-white/5 border border-blue-400/20 shadow-2xl overflow-x-auto">
        <div className="px-4 sm:px-8 py-4 sm:py-6 bg-gradient-to-r from-blue-600/30 via-blue-500/20 to-cyan-600/20 border-b border-blue-400/30">
          ...
          <table className="min-w-full">
            <thead>
              <tr className="text-left text-blue-200 border-b border-blue-400/20">
                <th className="px-4 sm:px-8 py-4 sm:py-5 font-medium">
                  Service
                </th>
                <th className="px-4 sm:px-8 py-4 sm:py-5 font-medium">
                  Amount
                ...
                <th className="px-4 sm:px-8 py-4 sm:py-5 font-medium">Date</th>
              </tr>
            </thead>
            <tbody>
              {paidPayments.map((p) => (
                ...
                >
                  <td className="px-4 sm:px-8 py-3 sm:py-6 text-white font-medium">
                    {p.serviceName}
                  </td>
                  ...
                  <td className="px-4 sm:px-8 py-3 sm:py-6 text-gray-300">
                    {p.senderEmail}
                  </td>
                  <td className="px-4 sm:px-8 py-3 sm:py-6 text-blue-200">
